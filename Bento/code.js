...
// ---- Core generation ----
async function generateBento(p) {
    ...
    const taken = []; // for potential future overlap checks
    const labels = [];
...
figma.ui.onmessage = (msg) => {
    if (msg.type === 'generate') {
        generateBento(msg.payload).then(() => figma.closePlugin());
    }
